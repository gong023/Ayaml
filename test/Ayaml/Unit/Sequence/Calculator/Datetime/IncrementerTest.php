...
class IncrementerTest extends \PHPUnit_Framework_TestCase
{
    use AssertChain;
    ...
    {
        $days = $this->subject->between('created', '2014-01-01 00:00:00', '2014-01-03 00:00:00')->byDay();
    ...
    {
        $days = $this->subject->between('created', '2014-01-01 00:00:00', '2014-01-21 00:00:00')->byWeek();
    ...
    {
        $days = $this->subject->between('created', '2014-01-01 00:00:00', '2014-03-01 00:00:00')->byMonth();
    ...
    {
        $days = $this->subject->between('created', '2014-01-01 00:00:00', '2016-01-01 00:00:00')->byYear();
